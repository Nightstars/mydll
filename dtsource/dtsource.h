...
//query all databases
extern "C" _declspec(dllexport) int q_db(const char* db_url, const char* db_name, const char* db_sql, char** result);
//query all datatables in a sure database
extern "C" _declspec(dllexport) int q_dt(const char* db_url, const char* db_name, const char* db_sql, char** result);
